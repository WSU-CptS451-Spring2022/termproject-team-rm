...
def insert2BusinessTable():
    with open('//content/drive/MyDrive/yelp_business.JSON','r') as f:    #TODO: update path for the input file
...
def insert2UserTable():
    with open('//content/drive/MyDrive/yelp_user.JSON','r') as f:    #TODO: update path for the input file
        #outfile =  open('./yelp_business_out.SQL', 'w')  #uncomment this line if you are writing the INSERT statements to an output file.
        line = f.readline()
        count_line = 0
...
def insert2TipTable():
    with open('//content/drive/MyDrive/yelp_tip.JSON','r') as f:    #TODO: update path for the input file
...
def insert2CheckinTable():
    with open('//content/drive/MyDrive/yelp_checkin.JSON','r') as f:    #TODO: update path for the input file
